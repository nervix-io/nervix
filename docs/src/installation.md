...
Nervix does not yet publish stable binary or container-image releases. Choose the installation
...
Pin a reviewed Git commit or container-image digest when you need a reproducible installation.
