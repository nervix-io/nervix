...
impl From<ProcessorInputWhere> for StoredProcessorInputWhere {
    fn from(value: ProcessorInputWhere) -> Self {
        Self {
            relay: value.relay.to_string(),
...
impl TryFrom<StoredProcessorInputWhere> for ProcessorInputWhere {
    type Error = Report<NameError>;
...
impl From<CreateWasmProcessor> for StoredCreateWasmProcessor {
    fn from(value: CreateWasmProcessor) -> Self {
        Self {
            ...
            resource_version: value.resource_version,
            file: value.file,
            max_fuel: value.limits.max_fuel,
            max_memory_bytes: value.limits.max_memory_bytes,
            mode: value.mode,
...
mod tests {
    ...
    fn stored_type_enums_roundtrip_to_runtime_enums() {
        ...
        assert_eq!(
            ParseAsType::from(StoredParseAsType::from(nested.clone())),
            nested
        );
        assert_eq!(
