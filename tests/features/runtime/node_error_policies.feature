Feature: Runtime node error policies
  Scenario Outline: Runtime nodes require their mandatory error policy blocks
    ...
    Examples:
      ...
      | forwarder        | CREATE FORWARDER pass_through FROM notifications TO forwarded_notifications UNPARAMETERIZED FLUSH EACH 100ms MAX BATCH SIZE 1MiB                                                                                                                                                                                                                                                                     |
  ...
  Scenario Outline: Pure runtime processors reject general error policies
    ...
    Examples:
      ...
      | forwarder        | CREATE FORWARDER pass_through FROM notifications TO forwarded_notifications UNPARAMETERIZED FLUSH EACH 100ms MAX BATCH SIZE 1MiB ON MESSAGE ERROR LOG ON GENERAL ERROR LOG                                                                                                                                 |
