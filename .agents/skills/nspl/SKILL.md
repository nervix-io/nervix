...
- For syslog, read the dedicated `Syslog` documentation entry. Keep the fixed-contract codec
  independent of the UDP/TCP/TLS client transport, and use only the documented `NO_ACK` source
  and sink forms.
